...
java { toolchain { languageVersion.set(JavaLanguageVersion.of(libs.javaVersion.majorVersion)) } }
...
private fun plugin(provider: Provider<PluginDependency>) =
...
gradlePlugin {
    plugins {
        ...
        register("androidApp") {
            ...
            implementationClass =
                "ninja.bryansills.loudping.gradle.plugin.AndroidAppConventionPlugin"
        }
        register("javaAndroidLibrary") {
            id = "ninja.bryansills.android.library"
            implementationClass =
                "ninja.bryansills.loudping.gradle.plugin.JavaAndroidLibraryConventionPlugin"
        }
        register("kotlinAndroidLibrary") {
            id = "ninja.bryansills.android.library.kotlin"
            implementationClass =
                "ninja.bryansills.loudping.gradle.plugin.KotlinAndroidLibraryConventionPlugin"
        }
        register("kotlinAndroidDaggerLibrary") {
            id = "ninja.bryansills.android.library.kotlin.dagger"
            implementationClass =
                "ninja.bryansills.loudping.gradle.plugin.KotlinAndroidDaggerLibraryConventionPlugin"
        }
        register("kotlinMultiplatformLibrary") {
            id = "ninja.bryansills.multiplatform.library"
            implementationClass =
                "ninja.bryansills.loudping.gradle.plugin.KotlinMultiplatformLibraryConventionPlugin"
        }
        register("composeMultiplatformLibrary") {
            id = "ninja.bryansills.multiplatform.library.compose"
            implementationClass =
                "ninja.bryansills.loudping.gradle.plugin.ComposeMultiplatformLibraryConventionPlugin"
        }
        register("composeAndroidScreen") {
            id = "ninja.bryansills.android.library.compose.screen"
            implementationClass =
                "ninja.bryansills.loudping.gradle.plugin.ComposeAndroidScreenConventionPlugin"
        }
        register("composeMosaic") {
            id = "ninja.bryansills.compose.mosaic"
            implementationClass =
                "ninja.bryansills.loudping.gradle.plugin.ComposeMosaicConventionPlugin"
        }
        register("sqldelight") {
            id = "ninja.bryansills.sqldelight"
            implementationClass =
                "ninja.bryansills.loudping.gradle.plugin.SqldelightConventionPlugin"
        }
    }
}

plugins { id("ninja.bryansills.sqldelight") }
...
kotlin {
  sourceSets {
    ...
    jvmMain.dependencies { implementation(libs.sqldelight.jvm.driver) }
  }
}

android { namespace = "ninja.bryansills.loudping.database" }

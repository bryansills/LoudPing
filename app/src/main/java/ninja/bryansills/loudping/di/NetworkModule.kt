...
interface NetworkModule {
  companion object {
    ...
    @Singleton
    @Provides
    fun provideAccessTokenInterceptor(authManager: AuthManager): AccessTokenInterceptor =
      AccessTokenInterceptor(authManager)
    ...
    @Singleton
    @Provides
    fun provideNetworkService(spotifyService: SpotifyService): NetworkService =
      RealNetworkService(spotifyService)

    @Provides
    fun provideGetRecentlyPlayed(spotifyService: SpotifyService): GetRecentlyPlayed =
      RealGetRecentlyPlayed(spotifyService = spotifyService)
  }
}

...
@Serializable data class AlbumTracks(val next: String, val total: Int, val items: List<AlbumTrack>)
...
@Serializable data class AlbumImage(val url: String, val width: Int?, val height: Int?)

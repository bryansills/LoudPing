...
@Serializable
data class PlayHistoryItem(val played_at: Instant, val context: Context, val track: Track) {
    @Serializable data class Context(val type: ContextType, val href: String, val uri: String)
}

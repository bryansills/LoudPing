...
interface SpotifyService {
  @GET("/v1/me") suspend fun getMe(): ApiResult<PrivateUserResponse, Unit>
  ...
  /**
   * @param ids A comma-separated list of the Spotify IDs. For example:
   *   ids=4iV5W9uYEdYUVa79Axb7Rh,1301WleyT98MSxVHPZCA6M. Maximum: 20 IDs.
   */
  @GET("/v1/albums")
  suspend fun getSeveralAlbums(@Query("ids") ids: String): ApiResult<SeveralAlbumsResponse, Unit>

  @GET suspend fun getSeveralAlbumsUrl(@Url fullUrl: String): ApiResult<SeveralAlbumsResponse, Unit>
}

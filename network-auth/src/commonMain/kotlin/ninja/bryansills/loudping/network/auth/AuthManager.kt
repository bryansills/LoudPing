...
interface AuthManager {
  /**
   * @param startTime An Instant in which this request starts. This value should be kept around by
   *   the client. It will be provided to `setAuthorizationCode()` after the service returns back an
   *   authorization code.
   */
